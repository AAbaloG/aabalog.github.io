...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/canny.PNG" alt="" style="width:75%">
...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/correspondencias.PNG" alt="" style="width:75%">
