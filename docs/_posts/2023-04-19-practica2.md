...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/Week9/canny.PNG" alt="" style="width:75%">
  <figcaption>Filtro de bordes sobre las imágenes izquierda y derecha.</figcaption>
</figure>
...
<figure class="half">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/Week9/correspondencias.PNG" alt="" style="width:75%">
  <figcaption>Píxeles homólogos de los píxeles de interés de la imagen izquierda marcados sobre la imagen derecha.</figcaption>
</figure>
...
Encontrando $P_a$ y $P_b$ a partir de $\mu_a$ y $\mu_b$, encontramos el punto más cercano a ambas rectas como el punto medio del segmento $\={P_a P_b}$.
