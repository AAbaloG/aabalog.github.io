...
<figure class="half">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/1.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/2.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/3.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/4.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/5.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/6.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/7.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/8.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/9.png" alt="" style="width:40%">
...
<figure class="half">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/p1.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/p2.png" alt="" style="width:40%">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/images/calib/p3.png" alt="" style="width:40%">
